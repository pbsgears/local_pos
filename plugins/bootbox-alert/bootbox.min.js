...
!function (a, b) {
    ...
    var n = {
        dialog: "<div class='bootbox modal' tabindex='-1' role='dialog' style='z-index:999999'><div class='modal-dialog'><div class='modal-content' style='border-radius: 0px;'><div class='modal-body'><div class='bootbox-body'></div></div></div></div></div>",
        header: "<div class='modal-header'><h4 class='modal-title'></h4></div>",
        footer: "<div class='modal-footer' style='padding:8px;'></div>",
        closeButton: "<button type='button' class='bootbox-close-button close' style='margin-right: -10px; color: red;' data-dismiss='modal' aria-hidden='true'>&times;</button>",
    ...
    p.alert = function () {
        ...
        if (g(j, function (a, b) {
            ...
            }), i.find(".bootbox-body").html(a.message), a.animate === !0 && d.addClass(""), a.className && d.addClass(a.className), "large" === a.size ? f.addClass("modal-lg") : "small" === a.size && f.addClass("modal-sm"), a.title && i.before(n.header), a.closeButton) {
