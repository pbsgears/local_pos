...
CREATE TABLE `srp_employeesdetails` (
  ...
  `AirportDestinationID` int(11) DEFAULT NULL,
  ...
  `EthumbnailImage` varchar(255) DEFAULT NULL,
  `Gender` varchar(1) DEFAULT NULL,
  `payee_emp_type` int(11) DEFAULT NULL,
  ...
  `commissionSchemeID` int(11) DEFAULT '0' COMMENT 'fk => srp_erp_pay_commissionscheme.id',
  `medicalInfo` text,
  `SchMasterId` int(11) DEFAULT '0',
  `branchID` int(11) DEFAULT NULL,
  `userType` int(1) DEFAULT '0' COMMENT '0- Basic User  1 - module User',
  `isSystemUserYN` int(1) DEFAULT '0' COMMENT 'Differentiate system user for TIE',
  ...
  `gratuityCalculationDate` date DEFAULT NULL,
  ...
  `pos_userGroupMasterID_gpos` tinyint(4) DEFAULT NULL,
  `pos_barCode` varchar(255) DEFAULT NULL,
  `isLocalPosSyncEnable` int(1) DEFAULT '0',
  `isLocalPosSalesRptEnable` int(1) DEFAULT '0',
  `tibianType` int(2) DEFAULT NULL COMMENT 'Fk => srp_erp_tibian_employeetype.id',
...
-- ----------------------------
INSERT INTO `srp_employeesdetails` VALUES ('1139', null, 'RCC/EMP000002', 'RCC/EMP000002', '21', '', null, '44', 'Abolade Gbadegesin', 'A . Gbadegesin', null, 'Abolade', null, null, null, null, 'Abolad', null, null, null, null, null, null, null, 'rccemp000002_1488866058.jpg', null, '1', null, '1082', 'Forsyth Line Rd', 'rural Hall', '150', '27045  ', '+1-815-852-6776', '(336) 969-5610', null, '1082', 'Forsyth Line Rd', 'Rural Hall', '150', '1082', '1082', null, '+1-618-548-9166', null, '(336) 969-5610', '+1-773-815-5371', 'Gbadegesin@gmail.com', null, '1969-09-30', '2013-10-16', '509213727', null, '750271045', null, null, '45', '40', '', null, '0', null, '0', '0', '0', '0', 'pos@mail.com', 'e10adc3949ba59abbe56e057f20f883e', '0', '0', '0', '0', '1', '2', 'USD', '0', null, null, '1', '2013-10-16', null, '0', null, '1', null, null, null, null, '0', '2', null, '0', '0', 'Mushtak Ahamed M', '2016-11-16 18:07:59', '192.168.1.33', 'Alex', '2018-12-16 04:42:52', '124.43.20.242', '1', '0', '2', null, null, null, '7', '11', '10', '0', '4029', '1', '0', '0', null, '0', null, '0', '0', null, null, null, null, null, '1', null, null, '1', '6', null, '', '1', '0', null, 'POS');
...
CREATE TABLE `srp_erp_chartofaccounts` (
  ...
  `deletedYN` tinyint(1) DEFAULT '0',
  `deleteByEmpID` varchar(45) DEFAULT NULL,
  ...
  `isDefaultlBank` int(1) DEFAULT '0' COMMENT '0- No 1 - Yes',
...
CREATE TABLE `srp_erp_company` (
  ...
  `default_segment_id` int(11) DEFAULT '0',
  `supportURL` text,
...
CREATE TABLE `srp_erp_customerinvoicedetails` (
  ...
  `boqDetailID` int(11) DEFAULT NULL,
  `isVariation` int(1) DEFAULT NULL,
  `boqPreviousClaimPercentage` double DEFAULT NULL,
  `boqClaimPercentage` double DEFAULT NULL,
  `boqTotalClaimPercentage` double DEFAULT NULL,
  `boqPreviousClaimedAmount` double DEFAULT NULL,
  `boqTotalClaimedAmount` double DEFAULT NULL,
  `DOMasterID` int(11) DEFAULT NULL COMMENT 'fk =>srp_erp_deliveryorder.DOAutoID',
  `due_amount` double DEFAULT NULL COMMENT 'delivery order due amount when invoice is created',
  `balance_amount` double DEFAULT NULL,
  `projectID` int(11) DEFAULT NULL,
  `project_categoryID` int(11) DEFAULT NULL,
  `project_subCategoryID` int(11) DEFAULT NULL,
  `projectExchangeRate` double DEFAULT '1',
  `projectDocumentID` varchar(10) DEFAULT NULL,
  `projectDocumentMasterAutoID` int(11) DEFAULT NULL,
  ...
  `marginPercentage` double DEFAULT '0',
  `marginAmount` double DEFAULT '0',
  `marginLocalAmount` double DEFAULT '0',
  `marginReportingAmount` double DEFAULT '0',
  `marginCustomerAmount` double DEFAULT '0',
  `marginGLAutoID` int(11) DEFAULT NULL,
  ...
  `is_sync` int(1) DEFAULT '0',
  `id_store` int(255) NOT NULL DEFAULT '0',
  `contractDetailType` varchar(255) DEFAULT NULL,
  `contractDetailID` int(11) DEFAULT NULL,
  `ticketNo` varchar(255) DEFAULT NULL,
  `previousCertified` int(11) DEFAULT NULL,
  `currentCertified` int(11) DEFAULT NULL,
  `previousCertifiedAmount` double DEFAULT NULL,
  `callOffID` int(11) DEFAULT NULL,
  `callOffDescription` varchar(255) DEFAULT NULL,
...
CREATE TABLE `srp_erp_customerinvoicedetails_sync` (
  ...
  `relatedMasterAutoID` int(11) DEFAULT NULL,
  `createdUserGroup` int(11) DEFAULT NULL,
  `createdPCID` varchar(45) DEFAULT NULL,
  `createdUserID` varchar(45) DEFAULT NULL,
  `createdDateTime` datetime DEFAULT NULL,
...
CREATE TABLE `srp_erp_customerinvoicemaster` (
  ...
  `isSytemGenerated` int(1) DEFAULT '0' COMMENT '0 - No 1- Yes',
  ...
  `insuranceSubTypeID` int(11) DEFAULT NULL,
  ...
  `rebateGLAutoID` int(11) DEFAULT NULL,
  `rebatePercentage` double DEFAULT NULL,
  `rebateAmount` double DEFAULT '0',
  ...
  `logisticBLNo` varchar(45) DEFAULT NULL,
  `logisticContainerNo` varchar(45) DEFAULT NULL,
  ...
  `is_sync` int(1) DEFAULT '0',
  `id_store` int(255) NOT NULL DEFAULT '0',
  `isOpYN` int(1) unsigned zerofill DEFAULT '0',
  `retentionPercentage` double DEFAULT '0',
  `retensionTransactionAmount` double DEFAULT '0',
  `retensionLocalAmount` double DEFAULT '0',
  `retensionReportingAmount` double DEFAULT '0',
  `retensionInvoiceID` int(11) DEFAULT NULL,
...
CREATE TABLE `srp_erp_documentcodemaster` (
  ...
  `isFYBasedSerialNo` int(1) DEFAULT '0' COMMENT '0- No 1 - YES',
  `printHeaderFooterYN` int(1) DEFAULT '1',
  `printFooterYN` int(1) DEFAULT '0',
  `companyID` int(11) DEFAULT NULL,
  `companyCode` varchar(45) DEFAULT NULL,
  `createdUserGroup` int(11) DEFAULT NULL,
  `createdPCID` varchar(45) DEFAULT NULL,
...
CREATE TABLE `srp_erp_itemledger` (
  ...
  `SUOMID` int(11) DEFAULT NULL COMMENT 'Secondary UOM ID',
  `SUOMQty` double DEFAULT NULL COMMENT 'Secondary UOM Qty',
...
CREATE TABLE `srp_erp_itemmaster` (
  ...
  `secondaryUOMID` int(11) DEFAULT NULL,
  ...
  `deletedYN` int(1) DEFAULT '0',
  `deleteByEmpID` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `deletedDatetime` datetime DEFAULT NULL,
  `comments` text,
  ...
  `finCompanyPercentage` double DEFAULT '100',
  `pvtCompanyPercentage` double DEFAULT '0',
  `masterConfirmedYN` int(1) DEFAULT '0',
  `masterConfirmedByEmpID` varchar(100) DEFAULT NULL,
  `masterConfirmedByName` varchar(300) DEFAULT NULL,
  `masterConfirmedDate` datetime DEFAULT NULL,
  `masterApprovedYN` int(1) DEFAULT '0',
  `masterApprovedDate` datetime DEFAULT NULL,
  `masterCurrentLevelNo` int(1) DEFAULT '1',
  `masterApprovedbyEmpID` varchar(45) DEFAULT NULL,
  `masterApprovedbyEmpName` varchar(200) DEFAULT NULL,
  `companyID` int(11) DEFAULT NULL,
  `companyCode` varchar(45) DEFAULT NULL,
  `createdUserGroup` int(11) DEFAULT NULL,
  `createdPCID` varchar(45) DEFAULT NULL,
...
CREATE TABLE `srp_erp_pos_auth_processassign` (
  ...
  `posType` int(1) DEFAULT '1' COMMENT '1=RPOS , 2=GPOS',
  `capAmount` double DEFAULT NULL,
  `capPercentage` double DEFAULT NULL,
  `companyID` int(11) DEFAULT NULL,
  `createdPCID` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  `createdUserID` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  `createdDateTime` datetime DEFAULT NULL,
...
CREATE TABLE `srp_erp_pos_crewroles` (
  ...
  `modifiedUserName` varchar(200) DEFAULT NULL,
  `timeStamp` timestamp NULL DEFAULT NULL,
  `isDeliveryPerson` int(11) DEFAULT '0',
...
CREATE TABLE `srp_erp_pos_customermaster` (
  ...
  `customerCountryId` int(11) DEFAULT '0',
  `customerCountryCode` varchar(5) DEFAULT NULL,
  `customerCountry` varchar(100) DEFAULT NULL,
...
CREATE TABLE `srp_erp_pos_menudetails` (
  ...
  `defaultUomId` int(11) DEFAULT NULL,
  `defaultUnitCost` double DEFAULT '0',
...
CREATE TABLE `srp_erp_pos_menusalesitems` (
  ...
  `KOTStartDateTime` datetime DEFAULT NULL,
  `KOTEndDateTime` datetime DEFAULT NULL,
  `KOTDoneByEmpID` int(11) DEFAULT NULL,
...
CREATE TABLE `srp_erp_pos_menusalesmaster` (
  ...
  `preparationTime` double DEFAULT '20',
  `KOTStartDateTime` datetime DEFAULT NULL,
  `KOTEndDateTime` datetime DEFAULT NULL,
  `KOTDoneByEmpID` int(11) DEFAULT NULL,
  `wowFoodYN` int(1) DEFAULT '0' COMMENT '0 - No 1 - Yes ',
  `wowFoodStatus` int(1) DEFAULT '0' COMMENT '0 - Order Placed 1- Being Prepared 2 - Dispatched 3 - Delivered',
  `wowFoodCustomerName` varchar(250) DEFAULT NULL,
  `wowFoodCustomerTel` varchar(50) DEFAULT NULL,
  ...
  `isUpdated` int(1) DEFAULT '0' COMMENT '0 - No 1 Yes ',
  `isFromTablet` int(1) DEFAULT '0' COMMENT 'if the record created from tablet window',
  `deliveryRevenueGLID` int(11) DEFAULT NULL,
  `ownDeliveryPercentage` double DEFAULT NULL,
  `ownDeliveryAmount` double DEFAULT NULL,
...
CREATE TABLE `srp_erp_pos_shiftdetails` (
  ...
  `isFinanceClosed` tinyint(1) DEFAULT '0',
...
CREATE TABLE `srp_erp_taxmaster` (
  ...
  `taxShortCode` varchar(5) NOT NULL,
  `taxType` tinyint(1) DEFAULT '1' COMMENT 'sales tax -1 purchase tax -2',
  `isClaimable` int(1) DEFAULT '1' COMMENT '0- no 1-yes',
  `isActive` tinyint(1) DEFAULT '1',
  `supplierAutoID` int(11) NOT NULL COMMENT 'Tax Authority - need to choose from supplier master',
  `supplierSystemCode` varchar(45) DEFAULT NULL,
  `supplierName` varchar(200) DEFAULT NULL,
...
CREATE TABLE `srp_erp_warehouse_users` (
  ...
  `companyID` int(11) DEFAULT NULL,
  `companyCode` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  `wareHouseAdminYN` int(1) DEFAULT '0' COMMENT 'if warehouse admin 1 else 0',
  `superAdminYN` int(1) DEFAULT '0' COMMENT 'if Super Admin 1 else 0',
  `createdUserGroup` int(11) DEFAULT NULL,
  `createdPCID` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  `createdUserID` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  `createdDateTime` datetime DEFAULT NULL,
